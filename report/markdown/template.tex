...
$if(toc)$
\begingroup
    \renewcommand{\contentsname}{\center Catalog \addcontentsline{toc}{chapter}{Catalog}}
   ...
   % \renewcommand{\listtablename}{\center 表目錄 \addcontentsline{toc}{chapter}{表目錄}}
    ...
    \renewcommand{\listfigurename}{\center Chart Catalog \addcontentsline{toc}{chapter}{Chart Catalog}}
